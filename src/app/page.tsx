...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Professional & Beautiful */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-2">
                  <span className="text-sky-500 text-xl">⭐</span>
                  <span className="text-sm font-medium text-gray-700">Since 2011</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative z-10">
                <img
                  src="https://storage.googleapis.com/workspace-ai-generated/image-7b8fd2f0-8d9b-412c-983f-adb0c6f8e3a5.jpg"
      ...
      {/* Services Preview - Clean & Professional */}
      ...
      {/* Why Choose Us - Beautiful Design */}
